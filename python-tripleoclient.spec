...
BuildRequires:  openstack-macros
BuildRequires:  validations-common >= 1.5.0
BuildRequires:  validations-common < 1.7.0
%if %{pyver} == 2
...
Requires:       validations-common >= 1.5.0
Requires:       validations-common < 1.7.0
Requires:       python%{pyver}-validations-libs >= 1.5.0
Requires:       python%{pyver}-validations-libs < 1.7.0
...
Requires:       sos
Requires:       openstack-tripleo-common >= 11.4.0
Requires:       python%{pyver}-tripleo-common >= 11.4.0
...
%changelog
* Fri Jun 04 2021 RDO <dev@lists.rdoproject.org> 12.6.0-1
- Update to 12.6.0

* Mon Feb 08 2021 RDO <dev@lists.rdoproject.org> 12.4.0-1
- Update to 12.4.0
